        ...
        <div className="space-y-6">
          {step === 'connect' && (
            <div className="text-center space-y-4">
              ...
              {/* Google / zkLogin sign-in — not yet enabled on mainnet (Enoki) */}
              <Button
                type="button"
                variant="outline"
              ...
              >
                ...
                <span className="ml-1 rounded-full bg-gray-100 dark:bg-gray-800 px-2 py-0.5 text-[10px] font-medium uppercase tracking-wide text-gray-500 dark:text-gray-400">
                  Coming soon
                </span>
              </Button>
            </div>
