...
export function PageCta({
  heading = "Your Words Deserve to Last",
  subtext = "Join a growing community of writers who publish on their own terms. Every article you write is permanently yours — owned by you, accessible to your readers, and free from platform risk.",
}: {
  heading?: string
  subtext?: string
}) {
